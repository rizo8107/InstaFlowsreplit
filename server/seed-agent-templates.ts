...
import type { InsertAgentTemplate } from "@shared/schema";

const templates: InsertAgentTemplate[] = [
  {
    name: "Customer Support Agent",
    description: "Automated customer support that answers questions, resolves issues, and escalates complex problems. Perfect for handling common inquiries 24/7.",
    icon: "💬",
    category: "customer-support",
    model: "gemini-2.5-flash",
    systemPrompt: `You are a helpful and professional customer support agent for an Instagram business account.
...
Remember: You represent the brand, so maintain a positive, helpful tone at all times.`,
    temperature: "0.7",
    maxTokens: "8192",
    enableMemory: true,
    enableTools: true,
    tools: ["send_instagram_dm", "search_knowledge_base", "trigger_flow"],
    isPublic: true,
    useCount: "0",
  },
  {
    name: "Lead Qualification Agent",
    description: "Engages potential customers, asks qualifying questions, and identifies high-value leads. Automatically routes qualified leads to your sales team.",
    icon: "🎯",
    category: "lead-qualification",
    model: "gemini-2.5-flash",
    systemPrompt: `You are a lead qualification specialist for an Instagram business account.
...
Keep it conversational, not interrogative. Build rapport while gathering information.`,
    temperature: "0.8",
    maxTokens: "8192",
    enableMemory: true,
    enableTools: true,
    tools: ["send_instagram_dm", "trigger_flow", "access_contacts"],
    isPublic: true,
    useCount: "0",
  },
  {
    name: "FAQ Bot",
    description: "Instantly answers frequently asked questions using your knowledge base. Reduces repetitive inquiries and provides 24/7 information access.",
    icon: "❓",
    category: "faq",
    model: "gemini-2.5-flash",
    systemPrompt: `You are an FAQ bot designed to answer common questions quickly and accurately.
...
Your goal is to provide instant, accurate answers that satisfy the customer quickly.`,
    temperature: "0.5",
    maxTokens: "4096",
    enableMemory: false,
    enableTools: true,
  ...
  },
  {
    ...
    description: "Converts interested prospects into customers by showcasing products, handling objections, and closing sales. Integrates with your sales workflows.",
    icon: "💰",
    category: "sales",
    model: "gemini-2.5-pro",
    systemPrompt: `You are a skilled sales assistant for an Instagram business, focused on converting prospects into customers.
...
Your success metric: Convert conversations into customers while maintaining brand reputation.`,
    temperature: "0.8",
    maxTokens: "8192",
    enableMemory: true,
    enableTools: true,
    tools: ["send_instagram_dm", "search_knowledge_base", "trigger_flow", "access_contacts"],
    isPublic: true,
    useCount: "0",
  },
  {
    name: "Appointment Scheduler",
    description: "Coordinates appointments, consultations, and bookings. Checks availability, confirms details, and sends reminders automatically.",
    icon: "📅",
    category: "scheduling",
    model: "gemini-2.5-flash",
    systemPrompt: `You are an appointment scheduling assistant for an Instagram business account.
...
End goal: Make booking as smooth and easy as possible for the customer.`,
    temperature: "0.7",
    maxTokens: "8192",
    enableMemory: true,
    enableTools: true,
  ...
  },
  {
    ...
    description: "Suggests personalized products based on customer preferences, browsing history, and needs. Increases cross-selling and upselling opportunities.",
    icon: "🛍️",
    category: "sales",
    model: "gemini-2.5-flash",
    systemPrompt: `You are a product recommendation specialist for an Instagram e-commerce business.
...
Your success: Help customers find exactly what they need, creating a delightful shopping experience.`,
    temperature: "0.7",
    maxTokens: "8192",
    enableMemory: true,
    enableTools: true,
...
export async function seedAgentTemplates() {
  ...
  try {
    ...
    console.log(`\n✅ Successfully seeded ${templates.length} agent templates!`);
  } catch (error: any) {
    console.error("❌ Error seeding agent templates:", error.message);
    throw error;
  }
}
